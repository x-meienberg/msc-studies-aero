...
The availability is estimated through the metric $U(t_j)$, which is the unavailability of the system, whereas the function $C^A(t_j)$ is a counter which only increases as long as the system is in a jailed state ($X(t_j) =2$) and hence 
