...
\textbf{Kostenfunktion}: Abhängig von Fixkosten (von produzierten Menge unabhängig) und variable Kosten (von prod. Menge abhängig/steigen mit Produktionsmenge an).

\begin{equation}
    K(x) = K_{fix}(x) + K_{var}(x)
\end{equation}
...
Die Preiselastizität variiert in der Regel entlang der Kurve. 
