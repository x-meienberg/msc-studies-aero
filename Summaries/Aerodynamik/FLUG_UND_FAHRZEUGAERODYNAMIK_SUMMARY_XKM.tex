...
\subsubsection{Kräfte am Fahrzeug}
    ...
    \begin{itemize}
        ...
        \item Auftrieb: $A = A_y + A_H$ (Rechnung: $F_A$, $A =$ Q. Fläche)
        \item Rollwiderstand: $W_R = W_{RV} + W_{RH}$
        \item $F_R = \mu_R F_Z$ mit $\mu_R = \mu_{R, Basis} / \mu(V=0)$
        \item $F_Z = F_G - F_A = mg - 1/2\rho V^2 c_A A$
        \item Beschleunigungswiderstand: $W_B = \dot{V}m(1+\varepsilon_i) = a_x m (1+\varepsilon_i)$
...
\begin{itemize}
    \item $B = (P_{aero} + P_{roll} + \Delta P_{mech})(SFC)(1000/\rho_{fuel})(100/V)$
    \item $V = [km/h]$, $SFC = [kg/kWh]$, $P = [kW]$, $B = [l/100km]$    
...
\begin{center}
    \includegraphics[width=7cm]{Kraefte_Fahrzeug_2.png}
\end{center}
