...
Für einen Punkt innerhalb einer Kugelschale erhält man ein konstantes Potential. Da der Gradient bei einer Konstanten verschwindet, übt die Kugelschale auf einen Massenpunkt im Innern keine Kraft aus.
\begin{equation*}
    V_{S,innen} = 0
\end{equation*}
